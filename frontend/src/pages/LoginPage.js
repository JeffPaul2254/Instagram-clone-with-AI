...
function MetaWordmark() {
  return (
    ...
    >
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id="ig-meta-a" x1="124.38" x2="160.839" y1="99" y2="59.326">
          <stop offset=".427" stopColor="#0278F1"/>
          <stop offset=".917" stopColor="#0180FA"/>
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id="ig-meta-b" x1="42" x2="-1.666" y1="4.936" y2="61.707">
          <stop offset=".427" stopColor="#0165E0"/>
          <stop offset=".917" stopColor="#0180FA"/>
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id="ig-meta-c" x1="27.677" x2="132.943" y1="28.71" y2="71.118">
      ...
      <path d="M145.631 36h-16.759c3.045 7.956 4.861 17.797 4.861 28.725 0 11.403-4.729 17.547-11.651 17.547H122v16.726l.449.002c16.448 0 27.617-13.723 27.617-33.25 0-10.85-1.6-20.917-4.435-29.75Z" fill="url(#ig-meta-a)"/>
      <path d="M42 .016C18.63.776.832 28.908.028 63h16.92C17.483 39.716 28.762 18.315 42 17.31V.017Z" fill="url(#ig-meta-b)"/>
